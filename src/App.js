        ...
        <div className="page-wrapper" asscroll="true">
          <section className="hero">
            <div className="hero-wrapper">
              ...
              <div className="hero-second">
                <p className="hero-second-subheading first-sub">Jaung</p>
          ...
          <section className="first-section section left">
            ...
            <div className="section-detail-wrapper">
              <p className="section-text">
                Hi there 👋! Lorem Ipsum is simply dummy text of the printing
          ...
          <section className="second-section section right">
            ...
            <div className="section-detail-wrapper">
              ...
              <h3 className="section-heading">BrainFlix</h3>
              <p className="section-text">
                Lorem Ipsum is simply dummy text of the printing and typesetting
                industry. Lorem Ipsum has been the industry's standard dummy
                text ever since the 1500s, when an unknown printer took a galley
