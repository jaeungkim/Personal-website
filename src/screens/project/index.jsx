        ...
        <Row className="justify-content-md-center">
          <Col sm>
            <div className="github_card">
              <a
                href="https://github.com/jaeungkim/Portfolio"
                rel="noopener noreferrer"
                target="_blank"
              >
                <img
            ...
            <div className="github_card">
              <a
                href="https://github.com/jaeungkim/Resume"
                rel="noopener noreferrer"
                target="_blank"
              >
                <img
            ...
            <div className="github_card">
              <a
                href="https://github.com/jaeungkim/CaffeineHolic"
                rel="noopener noreferrer"
                target="_blank"
              >
                <img
          ...
          <Col sm>
            <div className="github_card">
              <a
                href="https://github.com/jaeungkim/Lental"
                rel="noopener noreferrer"
                target="_blank"
              >
                <img
            ...
            <div className="github_card">
              <a
                href="https://github.com/jaeungkim/ChatBot"
                rel="noopener noreferrer"
                target="_blank"
              >
                <img
            ...
            <div className="github_card">
              <a
                href="https://github.com/jaeungkim/COSC419"
                rel="noopener noreferrer"
                target="_blank"
              >
                <img
